# WORKING 2/14/2017   
# Script for automating creation of velocity grids from point and polygon features generated from srh-2d modeling results
# Assumes depth grids have been created using "ImportSRH2Dcsv_DepthGrid.py" script (or equivalent)

# IMPROVEMENTS TO MAKE:  
# Promote snap raster definition to beginning of script, have user identify a depth grid previously created
...
outworkspace = r"C:\DanielProjects\AV_HabitatSuitability\habitat_lf_data_proposed"
...
# create list of point features used to create velocity grid
...
for feature in point_features:
	...
	velocity_grid = os.path.join(outworkspace,abbreviation + event +"_v")

	# create raster from point feature and elevation field with cell size 5
	arcpy.FeatureToRaster_conversion(feature,velocityfield, temp_raster1, 5)
