# WORKING 2/14/2017   
# Script for automating creation of shear stress grids from point and polygon features generated from srh-2d modeling results
...
### CSV Must be cleaned and formated with "X", "Y", and "Stress" column headings.  OR, script must be edited below
...
arcpy.env.workspace = r"C:\DanielProjects\AV_temp_final"
workspace = r"C:\DanielProjects\AV_temp_final"
...
# Define shear stress field
shearstressfield = "STRS"

# create list of point features used to create shearstress grid
...
for feature in point_features:
	...
	shearstress_grid = os.path.join(workspace,abbreviation + event +"_ss")

	# create raster from point feature and shear stress field with cell size 5
	arcpy.FeatureToRaster_conversion(feature,shearstressfield, temp_raster1, 5)
	...
	for feature in poly_features:
		...
		if event == split[1]: # designate if previously defined "event" (for current iteration) corresponds to polygon feature
			...
			extraction.save(shearstress_grid)
